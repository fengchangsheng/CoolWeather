...
//			List<Province> list =  XmlTools.parseXml(response);
...
//			List<City> list =  XmlTools.parseXmlCity(response,provinceId);
//			for (City  city:list) {
//				coolWeatherDB.saveCity(city);
//			}
//			return true;
...
//			List<County> list = XmlTools.parseXmlCounty(response,cityId);
